      ...
      <div className="flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex flex-1 flex-wrap items-center justify-end gap-3">
          ...
          <div className="relative shrink-0">
            ...
            {notificationsOpen ? (
              <div className="absolute right-0 top-full z-30 mt-2 w-[min(20rem,calc(100vw-3rem))] rounded-2xl border border-slate-200 bg-white p-4 text-sm shadow-lg">
          ...
          <div className="relative">
            ...
            {open ? (
              <div className="absolute right-0 top-full z-30 mt-2 w-44 rounded-xl border border-slate-200 bg-white p-2 text-sm shadow-lg">
                <button
