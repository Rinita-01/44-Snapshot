    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div
          ...
          style={{ backgroundColor: textColor === "#ffffff" ? "rgba(255, 255, 255, 0.18)" : "rgba(15, 23, 42, 0.08)", color: textColor }}
        >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={onDelete}
            style={{
              borderColor: textColor === "#ffffff" ? "rgba(255,255,255,0.28)" : "rgba(15,23,42,0.12)",
              color: mutedTextColor,
              backgroundColor: textColor === "#ffffff" ? "rgba(255,255,255,0.12)" : "rgba(255,255,255,0.55)"
            }}
            disabled={isDeleting}
            type="button"
